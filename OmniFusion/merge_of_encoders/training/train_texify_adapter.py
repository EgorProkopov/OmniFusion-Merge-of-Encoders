...
class Model_pl(pl.LightningModule):
    ...
    def on_train_epoch_end(self):
        torch.save(self.projection, f"/home/OmniFusion-Merge-of-Encoders/OmniFusion/merge_of_encoders/training/ckpts/{self.cfg.exp_name}/projection.pt")
        torch.save(self.encoder_projection, f"/home/OmniFusion-Merge-of-Encoders/OmniFusion/merge_of_encoders/training/ckpts/{self.cfg.exp_name}/{self.encoder_name}_projection.pt")
        torch.save(self.special_embs, f"/home/OmniFusion-Merge-of-Encoders/OmniFusion/merge_of_encoders/training/ckpts/{self.cfg.exp_name}/special_embeddings.pt")
    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.autocast(device_type="cuda", dtype=self.DTYPE):
            logits = self.model(inputs_embeds=embeddings.to(dtype=self.DTYPE), 
                                output_hidden_states=True).get("logits")[:, :-1]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, 
                        default='/home/OmniFusion-Merge-of-Encoders/OmniFusion/merge_of_encoders/training/configs/config-texify-adapter-pretrain.json')
    ...
    projection = VisualToGPTMapping(1024, cfg.emb_dim, cfg.vision_emb_num).to(dtype=DTYPE)
    ...
    special_embs = special_embs = torch.load(cfg.special_embs_ckp)
    ...
    trainer = pl.Trainer(
        devices=[2, 3], max_epochs=cfg.n_epochs,
        logger=[logger,],
